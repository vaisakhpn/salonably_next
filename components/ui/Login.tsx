        ...
        <div className="lg:col-span-7 flex flex-col justify-center bg-white">
          ...
          <div className="p-6 sm:p-10 lg:p-12 flex flex-col justify-center">
            ...
            <div className="relative mb-5">
              ...
              {googleLoading && (
                <div className="absolute inset-0 bg-white/80 backdrop-blur-xs rounded-full flex items-center justify-center gap-2 text-xs font-semibold text-blue-600">
              ...
              <div className="relative my-6 flex items-center justify-center">
                ...
                <span className="bg-white px-3 text-xs uppercase font-medium tracking-wider text-gray-400 absolute">
                  Or with email
                </span>
              </div>
            </div>
